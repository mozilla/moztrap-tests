...
class TestPinningFilters(BaseTest):
    ...
    def test_that_pinning_filter_on_product_version_set_defaults_in_new_run(self, base_url, selenium, login, product):
    ...
    def test_that_pinning_name_field_filter_only_works_for_current_page(self, api, base_url, selenium, login, product):
        good_case_name = u'mozilla'
        good_suite_name = u'MozTrap'

        self.create_bulk_cases(base_url, selenium, product, api=api, name=good_case_name, cases_amount=3)
        self.create_bulk_cases(base_url, selenium, product, api=api, name=u'ALLIZOM', cases_amount=2)
        self.create_suite(base_url, selenium, product, api=api, name=good_suite_name)
        self.create_suite(base_url, selenium, product, api=api, name=u'PartZom')
    ...
    def test_that_pinning_filters_on_product_sets_defaults_in_new_suite(self, base_url, selenium, login, product):
        manage_suites_pg = MozTrapManageSuitesPage(base_url, selenium)
        manage_suites_pg.go_to_manage_suites_page()
    ...
    def test_that_pinning_filters_on_product_and_version_and_suite_set_defaults_in_new_case(self, api, base_url, selenium, login, product):
    ...
    def test_that_pinning_filter_on_product_sets_defaults_in_new_product_version(self, base_url, selenium, login, product):
    ...
    def test_that_pinning_filter_persists_for_session(self, api, base_url, selenium, existing_user, login, product, element):
        # create suite, cases and test run
        product_version_name = u'%s %s' % (product['name'], product['version']['name'])
        case, suite, run = self.create_and_run_test(api, base_url, selenium, product, element)
